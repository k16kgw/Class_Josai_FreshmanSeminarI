...
> 私は大学で学ぶ内容を通して自分の得意なことや関心のある分野を見つけ，将来の目標を少しずつ明確にしたいと考えているので，授業だけでなく自主学習や大学生活での経験も大切にしたい．
````
...
※ 前者の意味にしたい場合には，説明する言葉を増やしてみると良い．

例：「体の小さな子供のプール」とすれば，「体の小さな」は「プール」を修飾することがないので，「子供」を修飾していると理解してもらえる．
...
ここでいう主語・述語の関係とは，「誰が・何が，どうした／どのようだ／何だ」という関係である．
ただし，日本語では主語が省略されることがあるため，主語が明示されていなくても，述語を中心にもつまとまりは節として考えるとよい．
...
この例では，「私が」が主語，「借りた」が述語である．
そのため，「私が昨日図書館で借りた」は節である．

次の例では主語が書かれていないが，「借りた」という述語がある．
「誰が借りたのか」は文脈から補うことができるため，「昨日図書館で借りた」も節として考えられる．

```text
昨日図書館で借りた本
```

なお，「昨日図書館で借りた本」全体は名詞として働く大きなまとまりなので，文法体系によっては名詞句として説明されることもある．
この授業では，修飾語の順序を考えるために，内部に述語「借りた」をもつ修飾部分を節として扱う．

**句**：文の一部として一つの働きをする語のまとまり．

句は，複数の語がまとまって一つの働きをするが，節のように主語・述語の関係を含まない．
この授業では，述語を中心にもたない短い修飾表現を句として扱う．
...
「数学の」「駅の近くの」「大学の図書館の」は名詞を修飾しているが，述語を中心にもつまとまりではない．
...
ただし，修飾語の順序を考える場面では，短い修飾表現として句と同じように扱ってよい．

節は述語を中心にもつため，情報量が多くなりやすい．
そのため，後ろに置くと文の構造が分かりにくくなることがある．
したがって，節を先に置き，短い句を後に置くと読みやすくなる場合が多い．
...
この文では，長い修飾語である「私が昨日図書館で借りた」を先に置き，短い修飾語である「厚い」「数学の」を後に置いている．

ただし，常にこの順序にすればよいわけではない．
大切なのは，読み手が「何が何を修飾しているのか」を迷わず理解できることである．

````{note} 演習3
次の語句を並べ替えて，読みやすい表現にせよ．

```text
新しい 私が大学で使う 数学の 教科書
```

並べ替えた後，どの語句が「教科書」を修飾しているかも説明せよ．
````
...
なお，解答は`第8回_<学籍番号>_<氏名>.pptx`に追記せよ．
...
最後に`第8回_<学籍番号>_<氏名>.pptx`を<span style="color:red">WebClassの「第8回課題」より提出</span>せよ．
````
