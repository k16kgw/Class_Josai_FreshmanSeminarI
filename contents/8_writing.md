...
したがって，<span style="color:red">節を先に置き，短い句を後に置くと読みやすくなる</span>場合が多い．
...
なお，解答は`第8回_<学籍番号>_<氏名>.docx`に追記し，`第8回_<学籍番号>_<氏名>.docx`を<span style="color:red">WebClassの「第8回課題」問1より提出</span>せよ．
...
最後に`第8回_<学籍番号>_<氏名>.pptx`を<span style="color:red">WebClassの「第8回課題」問2より提出</span>せよ．
````
