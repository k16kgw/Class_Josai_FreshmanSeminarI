...
Pythonはどこを読めなかったか，どの値を扱えなかったかを知らせている．
メッセージを手掛かりに少しずつ直す．
...
<img src="./figs/13/python_basic.png" alt="Pythonの基本用語の対応" width="800">
